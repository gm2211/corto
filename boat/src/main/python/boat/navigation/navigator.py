...
from shared.src.main.python.api.objects.nav_params.boat_attitude import BoatAttitude
from shared.src.main.python.api.objects.units.gps_coord import GPSCoord
from shared.src.main.python.api.objects.nav_params import NavParams
