from shared.src.main.python.api import SetDestination

from shared.src.main.python.api.objects.commands.send_telemetry import SendTelemetry
from shared.src.main.python.api.objects.commands.set_sail import SetSail
from shared.src.main.python.api.objects.commands.turn_rudder import TurnRudder
